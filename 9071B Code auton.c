...
{//starts driving to cube
	...
	{//drives to fence
		...
		motor[port5] = -100;
		wait(.50);
		//drives up to left side of fence
		motor[port2] = 100;
		motor[port3] = 100;
		motor[port4] = 100;
		motor[port5] = 100;
		wait(1.5);
		//knocks left side stars off fence
		motor[PincerL] = 100;
		motor[PincerR] = 100;
		wait(.75);
		motor[PincerL] = -100;
		...
		motor[port5] = 100;
		wait(5);
		//drives up to right side of fence
		motor[port2] = 100;
		motor[port3] = 100;
		motor[port4] = 100;
		motor[port5] = 100;
		wait(1.5);
		//knocks right side stars off fence
		motor[PincerL] = 100;
		motor[PincerR] = 100;
		wait(.75);
		motor[PincerL] = -100;
		...
		motor[port5] = 100;
		wait(.75);
		//drives to wall to grab second cube/grabs second cube
		motor[port2] = 100;
		motor[port3] = 100;
		motor[port4] = 100;
		motor[port5] = 100;
